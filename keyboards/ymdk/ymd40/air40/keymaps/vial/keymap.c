...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,  MO(2),   KC_LALT, KC_DEL,  KC_PGDN, KC_SPC,  KC_PGUP, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT, MS_LEFT),
    ...
    [1] = LAYOUT_ortho_4x12(
        ...
        MS_UP, MS_DOWN, MS_RGHT, MS_WHLU, MS_WHLD, MS_BTN1, MS_BTN2, MS_BTN3, MS_BTN4, RGB_SPD, RGB_VAD, RGB_SPI),

    [2] = LAYOUT_ortho_4x12(
        KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
        KC_CAPS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TRNS,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, KC_SLSH,
        KC_LCTL, KC_NO, KC_LALT, KC_DEL, KC_PGDN, KC_SPC,KC_TRNS, KC_PGUP, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT),
