...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       KC_A, LSFT_T(KC_R), LCTL_T(KC_S), LALT_T(KC_T), KC_G, KC_M, RALT_T(KC_N), RCTL_T(KC_E), RSFT_T(KC_I), KC_O,
       LGUI_T(KC_Z),    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,
                 KC_NO, LGUI(KC_TAB), LT(2, KC_TAB), LT(1, KC_SPC), LT(1, KC_SPC), KC_BSPC, TD(0), KC_MUTE
  ),
 ...
 */
  [LAYER_FUNCTION] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX, KC_PAUS,   KC_F1,   KC_F2,   KC_F3,  KC_F10,
                       KC_NO, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NO
  ),
 ...
 */
  [LAYER_NAVIGATION] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX,  KC_INS, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,
                       KC_NO, XXXXXXX, XXXXXXX, _______,  KC_ENT, KC_BSPC, KC_DEL, KC_NO
  ),
 ...
 */
  [LAYER_MEDIA] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                       KC_NO, _______, KC_MPLY, KC_MSTP, KC_MSTP, KC_MPLY, KC_MUTE, KC_NO
  ),
...
/** \brief Mouse emulation and pointer functions. */
  [LAYER_POINTER] = LAYOUT_split_3x5_3(
    ...
    _______, DRGSCRL, SNIPING, MS_BTN3, XXXXXXX, XXXXXXX, MS_BTN3, SNIPING, DRGSCRL, _______,
                       KC_NO, MS_BTN3, MS_BTN2, MS_BTN1, MS_BTN1, MS_BTN2, MS_BTN3, KC_NO
  ),
  ...
  [LAYER_NUMERAL] = LAYOUT_split_3x5_3(
    ...
    KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
     KC_DOT,    KC_1,    KC_2,    KC_3, KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, KC_RALT, XXXXXXX,
                        KC_NO, KC_DOT, KC_MINS,    KC_0, XXXXXXX, _______, XXXXXXX, KC_NO
  ),
 ...
 */
  [LAYER_SYMBOLS] = LAYOUT_split_3x5_3(
    ...
    KC_TILD, KC_EXLM,   KC_AT, KC_HASH, KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX, KC_RALT, XXXXXXX,
                       KC_NO, KC_RPRN,  KC_GRV, KC_UNDS, _______, XXXXXXX, XXXXXXX, KC_NO
  ),
};
// clang-format on
